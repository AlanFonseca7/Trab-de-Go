...
func (app *application) saveData(rw http.ResponseWriter, r *http.Request) {
	if r.Method != "POST" {
...
func (app *application) editPage(rw http.ResponseWriter, r *http.Request) {
...
func (app *application) editChanger(rw http.ResponseWriter, r *http.Request) {
	if r.Method != "POST" {
		rw.Header().Set("Allow", "POST")
		app.clientError(rw, http.StatusMethodNotAllowed)
		return
